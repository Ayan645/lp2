...
AIM:
To solve the 8-Puzzle problem using A* Search Algorithm.
...
A* selects node with minimum f(n).
...
It calculates distance of each tile from goal position.

----------------------------------------------------------------------------

DATA STRUCTURES USED:
1. Priority Queue
   - Selects best state first
...
TIME COMPLEXITY:
Depends on number of states explored.
